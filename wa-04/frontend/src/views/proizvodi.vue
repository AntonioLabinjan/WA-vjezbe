<template>
  <div v-if="proizvod && proizvod.slike && proizvod.slike.length > 0">
    <div class="bg-white">
      ...
      <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
        <div v-if="proizvod.slike[0]" class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
          <img :src="proizvod.slike[0]" alt="Product Image" class="h-full w-full object-cover object-center" />
        </div>
        <div v-if="proizvod.slike[1]" class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
          <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            <img :src="proizvod.slike[1]" alt="Gallery Image 1" class="h-full w-full object-cover object-center"/>
          </div>
        </div>
        <div v-if="proizvod.slike[2]" class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img :src="proizvod.slike[2]" alt="Gallery Image 2" class="h-full w-full object-cover object-center"/>
        </div>
        <div v-if="proizvod.slike[3]" class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img :src="proizvod.slike[3]" alt="Gallery Image 3" class="h-full w-full object-cover object-center"/>
        </div>
      </div>
