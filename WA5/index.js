...
app.get('/zaposlenici/:id', async (req, res) => {
    ...
    try {
        ...
        const filtered_zaposlenici = zaposlenici.find(zaposlenik => zaposlenik.id === dohvaceni_id);
        if (!filtered_zaposlenici) {
        ...
        return res.status(200).json(filtered_zaposlenici);
    } catch (error) {
